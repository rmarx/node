...
our %config = (
  ...
  builddir => ".",
  cc => "gcc",
  cflags => [ "-Wall -O3 -pthread -m64", "-Qunused-arguments" ],
  ...
  cxx => "g++",
  cxxflags => [ "-std=c++11 -Wall -O3 -pthread", "-Qunused-arguments" ],
  defines => [ "DSO_DLFCN", "HAVE_DLFCN_H", "NDEBUG", "OPENSSL_NO_DYNAMIC_ENGINE", "OPENSSL_PIC", "OPENSSL_BN_ASM_MONT", "SHA1_ASM", "SHA256_ASM", "SHA512_ASM", "AES_ASM", "VPAES_ASM", "ECP_NISTZ256_ASM", "POLY1305_ASM" ],
