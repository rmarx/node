...
#define DATE "built on: Mon Feb 12 22:16:48 2018 UTC"
...
static const char compiler_flags[] = {
    ...
    'h','r','e','a','d',' ','-','Q','u','n','u','s','e','d','-','a',
    'r','g','u','m','e','n','t','s',' ','-','D','D','S','O','_','D',
    'L','F','C','N',' ','-','D','H','A','V','E','_','D','L','F','C',
    'N','_','H',' ','-','D','N','D','E','B','U','G',' ','-','D','O',
    'P','E','N','S','S','L','_','N','O','_','D','Y','N','A','M','I',
    ...
    'L','Y','1','3','0','5','_','A','S','M',' ','-','D','F','I','L',
    'I','O','_','H',' ','-','D','L','_','E','N','D','I','A','N','\0'
};
