...
our %config = (
  ...
  perl_version => "5.22.1",
  perlargv => [ "no-shared", "no-comp", "no-ssl3", "no-afalgeng", "enable-tls1_3", "linux32-s390x" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
    ...
    "includes" =>
        {
            ...
            "crypto/aes/libcrypto-shlib-aes-s390x.o" =>
                [
                    "crypto",
                ],
            "crypto/arm64cpuid.o" =>
            ...
            "crypto/libcrypto-shlib-s390xcpuid.o" =>
                [
                    "crypto",
                ],
            ...
            "crypto/modes/libcrypto-shlib-ghash-s390x.o" =>
                [
                    "crypto",
                ],
            ...
            "crypto/sha/libcrypto-shlib-sha1-s390x.o" =>
                [
                    "crypto",
                ],
            "crypto/sha/libcrypto-shlib-sha256-s390x.o" =>
                [
                    "crypto",
                ],
            "crypto/sha/libcrypto-shlib-sha512-s390x.o" =>
                [
                    "crypto",
                ],
    ...
    "shared_sources" =>
        {
            "libcrypto" =>
                [
                    ...
                    "crypto/bn/libcrypto-shlib-s390x-gf2m.o",
                    "crypto/bn/libcrypto-shlib-s390x-mont.o",
                    ...
                    "crypto/chacha/libcrypto-shlib-chacha-s390x.o",
                    ...
                    "crypto/libcrypto-shlib-s390xcap.o",
                    "crypto/libcrypto-shlib-s390xcpuid.o",
                    ...
                    "crypto/poly1305/libcrypto-shlib-poly1305-s390x.o",
                    ...
                    "crypto/rc4/libcrypto-shlib-rc4-s390x.o",
                    ...
                    "crypto/sha/libcrypto-shlib-keccak1600-s390x.o",
                    "crypto/sha/libcrypto-shlib-sha1-s390x.o",
