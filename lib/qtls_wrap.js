...
QuicTLS.prototype.logQtlsWrap = function(message, ...args){
    if( this._tlsOptions.logLevel == "debug" || this._tlsOptions.logLevel == "trace" || this._tlsOptions.logLevel == "info" )
	console.log("lib/qtls_wrap.js: " + message, args );
}
...
function onerror(e) {
    debug(e);
    this.logQtlsWrap("onerror :", e );
    this.owner.emit("error", e);
}

function onhandshakedone() {
    debug("hs done");
    this.logQtlsWrap("onhandshakedone fired" );
    this.owner.emit("handshakedone");
}

function onnewsession() {
    debug("on new session");
    this.logQtlsWrap("onnewsession fired" );
